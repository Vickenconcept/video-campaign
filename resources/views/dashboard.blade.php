<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto pt-6 sm:px-6 lg:px-8 px-3 pb-32 overflow-y-auto h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <a href="{{ route('response.index') }}" class="bg-gradient-to-r from-orange-600 to-orange-700 text-white p-4 rounded-xl hover:from-orange-700 hover:to-orange-800 transition-all duration-200 flex items-center gap-3">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            @if($firstFiveResponses->count() > 0)
                ...
                <div class="px-6 py-4 border-t border-gray-200">
                    <a href="{{ route('response.index') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1">
                        View all responses
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <a href="{{ route('folder.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium">
