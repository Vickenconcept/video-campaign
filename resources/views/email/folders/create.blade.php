        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-white rounded-xl p-6 shadow-2xl shadow-gray-500/20 border border-gray-200 mb-8">
                <div class=" space-y-4 sm:space-y-0">
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        ...
                        <p class="text-gray-600">Organize your email campaigns with a custom folder</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-xl rounded-xl border border-gray-200 overflow-hidden">
                <div class="bg-gradient-to-r from-blue-50 to-blue-100 px-6 py-4 border-b border-blue-200">
                    <h2 class="text-lg font-semibold text-blue-900">Folder Information</h2>
                    <p class="text-blue-700 text-sm">Fill in the details below to create your new folder</p>
                </div>
                
                <form action="{{ route('email.folders.store') }}" method="POST" class="p-6">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" 
                                       ...
                                       class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-900">
                            </div>
                            @error('name')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="description" 
                                          ...
                                          class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-900 resize-none">{{ old('description') }}</textarea>
                            </div>
                            @error('description')
                                <div class="flex items-center gap-2 mt-2 text-red-600 text-sm">
                                    <i class='bx bx-error-circle'></i>
                        ...
                        <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-8 border-t border-gray-200">
                            ...
                            <button type="submit" 
                                    class="px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200 font-medium flex items-center justify-center gap-2">
