            ...
            <form action="{{ route('email.campaigns.update', $campaign) }}" method="POST" class="space-y-8">
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div>
                        ...
                        <textarea name="recipients" id="recipients" rows="4" required placeholder="email1@example.com, email2@example.com, email3@example.com" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('recipients', $recipients) }}</textarea>
                        <p class="text-sm text-gray-500 mt-1">Enter email addresses separated by commas</p>
                        @error('recipients')<p class="text-red-600 text-sm mt-1">{{ $message }}</p>@enderror
                    </div>
                </div>
                <div class="bg-white shadow-md rounded-lg p-6">
