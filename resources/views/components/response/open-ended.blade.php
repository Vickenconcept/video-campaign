<div x-data="responseRecorder()" class="w-full ">
    ...
    <div x-show="openResponse == null" style="display: none;" class="flex justify-center space-x-2">
        ...
        @if (!$step->allow_audio_response && !$step->allow_video_response && !$step->allow_text_response)
            <div class="w-full">
                ...
                <textarea id="textResponse" rows="10" x-model="textResponse" wire:model="textResponse" class="w-full"
    ...
    <div x-show="openResponse == 'audio'" style="display: none;">
        <div>
            ...
            <div class="my-4" x-data="{ isPlaying: false }">
                <button x-show="!isPlaying" class="rounded-md px-4 flex items-center space-x-2 py-2 cursor-pointer hover:shadow-lg shadow-inner hover:bg-white transition duration-500 ease-in-out border bg-slate-300 border-slate-500" @click="startAudioRecording(), isPlaying = true">
                    <i class='bx bx-play text-2xl'></i>
                    <span>Start Audio</span>
                </button>
                <button x-show="isPlaying" class="rounded-md px-4 flex items-center space-x-2 py-2 cursor-pointer hover:shadow-lg shadow-inner hover:bg-white transition duration-500 ease-in-out border bg-slate-300 border-slate-500" @click="stopAudioRecording(), isPlaying = false">
                    <i class='bx bx-pause text-2xl'></i>
